...
__decorate([TypeGraphQL.Query(_returns => [ProfileGroupBy_1.ProfileGroupBy], {
  nullable: false
}), __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, GroupByProfileArgs_1.GroupByProfileArgs]), __metadata("design:returntype", Promise)], GroupByProfileResolver.prototype, "groupByProfile", null);

GroupByProfileResolver = __decorate([TypeGraphQL.Resolver(_of => Profile_1.Profile)], GroupByProfileResolver);
